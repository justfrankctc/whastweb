...
class Registration
{
   ...
   */
  public function codeRequest($method = 'sms', $carrier = 'IUSACell/UneFon2', $platform = 'Android')
  {
      if (!$phone = $this->dissectPhone()) {
          throw new Exception('The provided phone number is not valid.');
      }

      $countryCode = ($phone['ISO3166'] != '') ? $phone['ISO3166'] : 'mx';
      $langCode = ($phone['ISO639'] != '') ? $phone['ISO639'] : 'es';
